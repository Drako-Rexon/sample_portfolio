...
class Constants {
  static List<List<List<String>>> pricelist = [
    [
      ["UI Design", AppImage.tick],
      ["web development", AppImage.tick],
      ["logo design", AppImage.cross],
      ["SEO optimization", AppImage.cross],
      ["WordPress integration", AppImage.cross],
      ["5 Websites", AppImage.cross],
      ["unlimited users", AppImage.cross],
      ["20 GB bandwidth", AppImage.cross]
    ],
    [
      ["UI Design", AppImage.tick],
      ["web development", AppImage.tick],
      ["logo design", AppImage.tick],
      ["SEO optimization", AppImage.tick],
      ["WordPress integration", AppImage.cross],
      ["5 Websites", AppImage.cross],
      ["unlimited users", AppImage.cross],
      ["20 GB bandwidth", AppImage.cross]
    ...
    [
      ...
      ["logo design", AppImage.tick],
      ["SEO optimization", AppImage.tick],
      ["WordPress integration", AppImage.tick],
      ["5 Websites", AppImage.tick],
      ["unlimited users", AppImage.tick],
      ["20 GB bandwidth", AppImage.tick]
    ]
  ];
